...
import INTI from "../assets/logo.jpeg";
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 py-20 px-6 sm:px-8 lg:px-16 text-center">
          ...
          <div className="relative z-10">
            ...
            <img
              src={INTI}
              alt="INTI International University Logo"
              className="mx-auto mb-8 mt-8 h-20 sm:h-24 rounded-xl shadow-lg transition-transform duration-500 hover:scale-105"
            />
